...
void mac_hwapi_get_flow_control(rdpa_emac emacNum,S_MAC_HWAPI_FLOW_CTRL *flowControl)
{
    ...
    uint32_t	misc_top_address, value;
...
static rdpa_emac_rx_stat_t rxCountersLast[rdpa_emac__num_of];
...
static rdpa_emac_tx_stat_t txCountersLast[rdpa_emac__num_of];
...
#endif
    memset(&rxCountersLast, 0, rdpa_emac__num_of*sizeof(rdpa_emac_rx_stat_t));
    memset(&txCountersLast, 0, rdpa_emac__num_of*sizeof(rdpa_emac_tx_stat_t));
