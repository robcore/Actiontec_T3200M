...
{
    { 2.5 * 1024, 0, 0 },
    { 5 * 1024, 0.5 * 1024, 4.5 * 1024 },
    { 7.5 * 1024, BPM_DEFAULT_DS_THRESHOLD, 5120 },
    { 10 * 1024, 0, 0 },
    { 12.5 * 1024, 0, 0 },
#ifdef G9991
    { 15 * 1024, 12 * 1024, 3 * 1024 },
#else
    { 15 * 1024, BPM_DEFAULT_DS_THRESHOLD, 12 * 1024 },
#endif
};
...
DRV_BPM_USER_GROUP_0 : DRV_BPM_USER_GROUP_1)
    ...
    bpm_ug_configuration.ug_arr[DRV_BPM_USER_GROUP_0].threshold = bpm_defenitions[global_thresh].ds_thresh;
    ...
    bpm_ug_configuration.ug_arr[DRV_BPM_USER_GROUP_1].threshold = bpm_defenitions[global_thresh].us_thresh;
...
#else
    f_ih_configure_target_matrix(0);
#endif
