...
#define CHIP_FAMILY_ID_HEX	0x6328
...
#define VDL_STATUS_CALIB_TOTAL_STEP_MASK     (0x3f<<VDL_STATUS_CALIB_TOTAL_STEP_SHIFT)
    uint32 unused;                  /* 0x0c */
...
#define PINMUX_PCIE_CLKREQ      ((uint64)2 << (PCIE_CLKREQ << 1))
...
#define MISC_STRAP_BUS_HS_SPIM_FAST_B_MASK      (1<<4)
