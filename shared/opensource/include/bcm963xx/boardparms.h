...
#define BP_EXT_INTR_TYPE_IRQ_LEVEL_MASK         (0x1 << 13)
#define BP_EXT_INTR_TYPE_IRQ_LOW_LEVEL          (0x0 << 13)
#define BP_EXT_INTR_TYPE_IRQ_HIGH_LEVEL         (0x1 << 13)
#define BP_EXT_INTR_TYPE_IRQ_SENSE_MASK         (0x1 << 14)
#define BP_EXT_INTR_TYPE_IRQ_SENSE_LEVEL        (0x0 << 14)
#define BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE         (0x1 << 14)
...
#define BP_AFE_CHIP_RNC                 (7 << 28) /* Unused so GFAST_CH0 is going to use the same values */
...
typedef struct {
  ...
  unsigned long portMaxRate[BP_MAX_SWITCH_PORTS];
...
#define MAC_IF_RGMII_2P5V       MAC_IF_RGMII
...
#define MAC_IF_RGMII_1P8V       (10 << MAC_IFACE_S)
#define MAC_IF_SERDES           (11 << MAC_IFACE_S)
...
#define PORT_FLAG_TRUNK_GROUP_0     (1 << 4)
#define PORT_FLAG_TRUNK_GROUP_1     (1 << 5)
#define PORT_FLAG_ATTACHED          (1 << 6)
#define PORT_FLAG_MIIPADCTRL        (1 << 7)
...
#define IsPortTrunkGrpEnabled(flags) (((flags) & (PORT_FLAG_TRUNK_GROUP_0|PORT_FLAG_TRUNK_GROUP_1)) != 0)
#define PortTrunkGroup(flags)        (((flags) & PORT_FLAG_TRUNK_GROUP_0) ? 0 : 1)
#define IsPortMiiPadCtrl(flags)      (((flags) & (PORT_FLAG_MIIPADCTRL)) != 0)
#if defined(GPL_CODE_EXT_SWITCH_PORT_ISOLATE)
#define IsPortToBeIsolatedAtInit(flags)      (((flags) & (PORT_FLAG_ISOLATE)) != 0)
#endif
...
#define BP_GPON_OPTICS_TYPE_PMD                 2
...
{
  unsigned long port_map;
  unsigned long ports[BP_MAX_ATTACHED_PORTS];
