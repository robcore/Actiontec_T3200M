...
#define INTERRUPT_ID_TIMER_0             (INTERNAL_HIGH_EXT_ISR_TABLE_OFFSET + 0)
#define INTERRUPT_ID_TIMER_1             (INTERNAL_HIGH_EXT_ISR_TABLE_OFFSET + 1)
#define INTERRUPT_ID_TIMER_2             (INTERNAL_HIGH_EXT_ISR_TABLE_OFFSET + 2)
#define INTERRUPT_ID_TIMER_3             (INTERNAL_HIGH_EXT_ISR_TABLE_OFFSET + 3)
