...
#include "bcmtypes.h"
#define MEMC_BASE                   0xb0014000
#define USBD_BASE                   0xb0009000  /* USB 2.0 device control */
#define USB_DMA_BASE                0xb0009800  /* USB 2.0 device DMA regiseters */
#define USBH_BASE		            0xb000c000  /* USBH control block*/
...
#define PCM_BASE                    0xb0010c00  /* PCM registers */
#define PCM_DMA_BASE                0xb0011000  /* PCM DMA registers */
#define PMC_BASE                    0xb0200000  /* PMC register */
#define PROC_MON_BASE               0xb0280000  /* Process Monitor register */
#define PCIE_BASE                   0xb0020000
#define PERF_BASE                   0xb0800000  /* chip control */
#define GENINT_BASE                 0xb0800000  /* general interrupt controller */
#define INT0_BASE                   0xb0800100  /* interrupts */
#define INT1_BASE                   0xb0800200  /* unused in 6848 */
#define INT2_BASE                   0xb0800300  /* unused in 6848 */
#define TIMR_BASE                   0xb0800400  /* timer registers */
#define GPIO_BASE                   0xb0800500  /* gpio registers */
#define BROM_BASE                   0xb0800600  /* bootrom registers */
#define BROM_SEC_BASE               0xb0800620  /* bootrom secure registers */
#define UART_BASE                   0xb0800640  /* uart 0 registers */
#define UART1_BASE                  0xb0800660  /* uart 1 registers */
#define LED_BASE                    0xb0800800  /* LED control registers */
#define JTAG_OTP_BASE               0xb0800e00  /* OTP control registers */
#define HSSPIM_BASE                 0xb0801000  /* High-Speed SPI registers */
#define NAND_REG_BASE               0xb0801800  /* nand control register */
#define NAND_INTR_BASE              0xb0802000  /* nand interrupt control */
#define NAND_CACHE_BASE             0xb0801c00  /* nand flash cache buffer */
#define MDIO_BASE      		        0xb08020c0  /* MDIO controller registers */
#define I2C_BASE		            0xb0802100  /* I2C interface register*/
#define MISC_BASE                   0xb0802600  /* Miscellaneous Registers */
#define USIM_BASE		            0xb0854000  /* SIM CARD interface registers*/
#define TOP_CNTRL_BASE		        0xb085a000  /* chip top control registers*/
