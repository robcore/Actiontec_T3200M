...
typedef struct flashaddrinfo
{
    ...
    int flash_customer_psi_start_blk;   /** store customer configFile as Factory configFile setting. **/
    int flash_customer_psi_number_blk;
#endif
#ifdef GPL_CODE_CUSTOMER_REVERT_FIRMWARE_CONFIG
    int flash_old_image_cfg_start_blk;   /** store customer configFile as Factory configFile setting. **/
    int flash_old_image_cfg_number_blk;
#endif
#ifdef GPL_CODE_DUAL_IMAGE_CONFIG
    int flash_image1_psi_start_blk;
    int flash_image1_psi_number_blk;
    int flash_image2_psi_start_blk;
    int flash_image2_psi_number_blk;
#endif
