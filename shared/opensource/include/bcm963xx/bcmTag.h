...
#define IMAGE1_SEQUENCE 0x201
#define IMAGE2_SEQUENCE 0x200
#define DEFAULT_IMAGE_SEQUENCE 0x00000000
#endif // AEI_VDSL_DUAL_IMAGE
#ifdef GPL_CODE
#define AEI_IMAGEINFO "Actiontec"
#endif
...
typedef struct _FILE_TAG
{
    ...
    char imageInfo[TOKEN_LEN];           // AEI image information such as Actiontec
    char reserved[RESERVED_LEN-TOKEN_LEN];        // reserved for later use
#else
...
#define WFI_FLAG_AEI_IMG_DUAL       0x2 /* Ken: flag to indicate flash the image to     dual partitions. */
...
#define AEI_MAGIC_BITMASK 0x3700
#if defined(_BCM963268_) || defined(CONFIG_BCM963268)
#define AEI_TAG_BLOCKS  1
#else
#define AEI_TAG_BLOCKS  8
#endif
#endif
