...
#define CHIP_FAMILY_ID_HEX	0x6318
...
#define RTC_BASE                    0xb0000800  /* RTC Control Registers */
...
#define ADSL_QPROC_EN       (1 << 30)
#define ADSL_AFE_EN         (1 << 29)
...
#define RGMII_PAD_SEL_2_5V   1
    ...
    uint32  unused2[1];                         /* 0x5c */
    uint32  miscTestPortCaptureHi;              /* 0x60 */
    uint32  miscTestPortCaptureLo;              /* 0x64 */
    uint32  unused3[1];                         /* 0x68 */
    uint32  miscPeriph_ECO_Register;            /* 0x6C */
#define MISC_RSW_UBUS_TIMEOUT     0x1
#define MISC_PCIE_CLKREQ_EN       0x2
} Misc;
