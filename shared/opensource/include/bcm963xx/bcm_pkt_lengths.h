...
#define BCM_DCACHE_LINE_LEN		64
#define BCM_DCACHE_ALIGN_LEN	63
...
#if defined(CONFIG_BCM963138) || defined(CONFIG_BCM963148) /* 63138/148 Runner FW flows don't support 2048 MTU */
...
#define BCM_MAX_PKT_LEN              ((BCM_MAX_MTU_EXTRA_SIZE + BCM_MAX_MTU_PAYLOAD_SIZE + 63) & ~63)
