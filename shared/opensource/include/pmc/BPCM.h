...
#if defined(_BCM963138_) || defined(CONFIG_BCM963138) || defined(_BCM963148_) || defined(CONFIG_BCM963148) || defined(_BCM963381_) || defined(CONFIG_BCM963381) || defined(_BCM96848_) || defined(CONFIG_BCM96848)
typedef union
{
	struct {
#ifdef PMC_LITTLE_ENDIAN
...
typedef union
{
	struct {
		...
		uint32 mdel0		: 3;	// 13:11
		uint32 reserved0	: 1;	// 14:14
		...
		uint32 mdel1		: 3;	// 29:27
		uint32 reserved1	: 1;	// 30:30
