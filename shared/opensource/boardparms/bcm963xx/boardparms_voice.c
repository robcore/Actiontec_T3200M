...
static VOICE_DAUGHTER_BOARD_PARMS * g_963168_NCS_dCardListFull[] = {
   &g_voiceBoard_SI3217x,
...
#if defined(GPL_CODE)
static bp_elem_t g_voice_bcm963168VX_C2000A[] = {                 
   ...
   {bp_usGpioFxsFxoRst3,        .u.us = BP_GPIO_9_AL},          
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_GPIO_8_AH},          
   {bp_daughterCardList,        .u.ptr = g_963168_NCS_dCardListFull},
   {bp_last}                                                    
};                 
#if 0
...
#if defined(GPL_CODE)
static VOICE_DAUGHTER_BOARD_PARMS * g_963138_NCS_dCardListFull[] = {
   &g_voiceBoard_NOSLIC,
   &g_voiceBoard_LE9672_ZSI,
   0
};
...
#if defined(GPL_CODE)
/* When HW is finalized and if profile is not needed, remove unneeded ones.
 *  */
static bp_elem_t g_voice_T3200BMV[] = {
   {bp_cpBoardId,               .u.cp = "T3200BMV"},
   {bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_PCM},
   {bp_daughterCardList,        .u.ptr = g_963138_NCS_dCardListFull},
   {bp_last}
};

static bp_elem_t g_voice_T3200MV[] = {
...
static bp_elem_t g_voice_T3200BV[] = {
...
static bp_elem_t g_voice_T3250V[] = {
...
static bp_elem_t g_voice_T3255V[] = {
   {bp_cpBoardId,               .u.cp = "T3255V"},
   {bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_PCM},
   {bp_daughterCardList,        .u.ptr = g_963138_NCS_dCardListFull},
   {bp_last}
};
static bp_elem_t g_voice_C3000[] = {
...
static bp_elem_t g_voice_F3500[] = {
