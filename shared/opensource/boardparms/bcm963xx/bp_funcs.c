...
#if defined(_BCM963138_) || defined(CONFIG_BCM963138) || defined(_BCM963381_) || defined(CONFIG_BCM963381) || defined(_BCM963148_) || defined(CONFIG_BCM963148) || defined(_BCM96848_) || defined(CONFIG_BCM96848)
...
static bp_pinmux_fn_defs_t g_pinmux_fn_defs[] = {
  ...
  { BP_PINMUX_FNTYPE_DEFAULT, 139 | BP_PINMUX_VAL_5 }, // Set DECT_MWR_LE default GPIO
  { BP_PINMUX_FNTYPE_DEFAULT, 140 | BP_PINMUX_VAL_5 }, // Set DECT_MWR_SK default GPIO
  { BP_PINMUX_FNTYPE_DEFAULT, 141 | BP_PINMUX_VAL_5 }, // Set DECT_MWR_SIO default GPIO
#endif
...
static bp_pinmux_defs_t g_pinmux_defs_0[] = {
  ...
  { bp_usPmdMACEwakeEn, -1, 10, 10 | BP_PINMUX_VAL_2},
  ...
  { bp_usLinkLed, 1, 9, 9|BP_PINMUX_VAL_3 | BP_PINMUX_DIRECT_HWLED }, // Link/Activity
  { bp_usLinkLed, 0, 5, 5|BP_PINMUX_VAL_1 | BP_PINMUX_DIRECT_HWLED },
  { bp_usLinkLed, 3, 52, 52|BP_PINMUX_VAL_2 | BP_PINMUX_DIRECT_HWLED },
  { bp_usLinkLed, 2, 54, 54|BP_PINMUX_VAL_2 | BP_PINMUX_DIRECT_HWLED },
...
* Name       : BpGetHwBoardId
*
* Description: This function returns the current hw board id .
*
* Parameters : [OUT] hwBoardId - Address of short word that the hw board id returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
***************************************************************************/
int BpGetHwBoardId( unsigned short *hwBoardId )
{
    return( BpGetUs(bp_usHwBoardId, hwBoardId) );
}
/**************************************************************************
* Name       : BpGetExtHwBoardId
*
* Description: This function returns the current external hw board id .
*
* Parameters : [OUT] hwBoardId - Address of short word that the hw board id returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
***************************************************************************/
int BpGetExtHwBoardId( unsigned short *hwBoardId )
{
    return( BpGetUs(bp_usExtHwBoardId, hwBoardId) );
}
#endif
/**************************************************************************
...
#ifdef GPL_CODE_DETECT_BOARD_ID
/**************************************************************************
* Name       : BpGetHwBoardIdByIndex
*
* Description: This function returns the pointer to the HW board id indexed by i. 
*
* Parameters : [OUT] Address of a buffer that the board id
*                    is returned in.
*              [IN]  Index of the board in the g_BoardParms array.            
...
* Returns    : BP_SUCCESS - Success, value is returned.
***************************************************************************/
int BpGetHwBoardIdByIndex( int i , int *value)
{
    if(g_BoardParms[i][1].id != bp_usHwBoardId){
        return BP_BOARD_ID_NOT_FOUND;
    }
    *value = g_BoardParms[i][1].u.us;

    return BP_SUCCESS;
}
/**************************************************************************
* Name       : BpGetExtHwBoardIdByIndex
*
* Description: This function returns the pointer to the external daughter card HW board id indexed by i. 
*
* Parameters : [OUT] Address of a buffer that the board id
*                    is returned in.
*              [IN]  Index of the board in the g_BoardParms array.            
...
* Returns    : BP_SUCCESS - Success, value is returned.
***************************************************************************/
int BpGetExtHwBoardIdByIndex( int i ,int *value)
{
    if(g_BoardParms[i][2].id != bp_usExtHwBoardId){
        return BP_BOARD_ID_NOT_FOUND;
    }
    *value = g_BoardParms[i][2].u.us;
...
/**************************************************************************
 * * Name       : BpGetWanEthLinkLedGpio
 * *
 * * Description: This function returns the GPIO pin assignment for WAN Ethernet link
 * *
 * *
 * * Parameters : [OUT] pusValue - Address of short word that the bp_usWanEthLinkLed
 * *                  GPIO pin is returned in.
 * *
 * * Returns    : BP_SUCCESS - Success, value is returned.
 * *              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
 * *              BP_VALUE_NOT_DEFINED - Not defined
 * ***************************************************************************/
int BpGetWanEthLinkLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usWanEthLinkLed, pusValue ) );
}

int BpGetWanEthSpeed100LedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usWanEthSpeedLed1000, pusValue ) );
}

int BpGetWanEthSpeed1000LedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usWanEthSpeedLed100, pusValue ) );
}
#endif
...
#if defined(_BCM963138_) || defined(CONFIG_BCM963138) || defined(_BCM963381_) || defined(CONFIG_BCM963381) || defined(_BCM963148_) || defined(CONFIG_BCM963148) || defined(CONFIG_BCM96848)
...
static int BpGrepPinmuxList(enum bp_id id,  unsigned short *pusFunction, unsigned long *pulMuxInfo) {
    int i;
...
static int BpGrepPinmuxListOnly(enum bp_id id, unsigned short gpionum,  unsigned short *pusFunction, unsigned long *pulMuxInfo) {
    int i;
    if (0 == g_pinmux_defs) {
...
*                  for the board.
***************************************************************************/
int BpGetPmdSDExtIntr( unsigned short *pusValue )
{
    return( BpGetUs(bp_usExtIntrPmdSD, pusValue ) );
} /* BpGetPmdSDExtIntr */
...
*                  for the board.
***************************************************************************/
int BpGetPmdSDExtIntrGpio( unsigned short *pusValue )
{
    int ret;
    ...
    ret = BpGetExtIntrGpio(bp_usExtIntrPmdSD, pusValue);

    return( ret );
} /* BpGetPmdSDExtIntrGpio */
        ...
        for (pelem=BpGetNextElem(pBtnIdxElem);pelem != NULL;pelem=BpGetNextElem(pelem)) {
            ...
            case bp_ulButtonActionParm:
                ...
                if (*pusNumHooks > 0 && *pusNumHooks < maxHooks)
                    parrulHookParms[*pusNumHooks-1]=(unsigned long)pelem->u.ul;
                else
                             ...
                             )
{
    ...
    int ret;
    do {
        ret = BpGetButtonInfo(&iter, &idx, pusGpio, pusExtIrq, pusNumHooks, parrusHooks, parrulHookParms);
        if (ret != BP_SUCCESS)
            return BP_NOT_DEFINED;
        if (btnIdx == idx) {
            return BP_SUCCESS;
...
/**************************************************************************
* Name       : BpGetWifi2_4GHzLedGpio
*
* Description: This function returns the GPIO pin assignment for 
*              2.4GHz Wifi Chip
*
*
* Parameters : [OUT] pusValue - Address of short word that the WLAN_PD
...
*                  for the board.
***************************************************************************/
int BpGetWifi2_4GHzLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioWifi2_4GHzLed, pusValue ) );
}

/**************************************************************************
* Name       : BpGetWifi5GHzLedGpio
*
* Description: This function returns the GPIO pin assignment for 
*              5GHz Wifi Chip
*
...
*                  for the board.
***************************************************************************/
int BpGetWifi5GHzLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioWifi5GHzLed, pusValue ) );
}


/**************************************************************************
* Name       : BpGetWanSfpLinkLedGpio
*
* Description: This function returns the GPIO pin assignment for WAN SFP link
*
*
* Parameters : [OUT] pusValue - Address of short word that the bp_usWanSfpLinkLed
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
*              BP_VALUE_NOT_DEFINED - Not defined
***************************************************************************/
int BpGetWanSfpLinkLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usWanSfpLinkLed, pusValue ) );
}

/**************************************************************************
* Name       : BpGetWanSfpLinkFailLedGpio
*
* Description: This function returns the GPIO pin assignment for WAN SFP link fail
*
*
* Parameters : [OUT] pusValue - Address of short word that the bp_usWanSfpLinkFailLed
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
*              BP_VALUE_NOT_DEFINED - Not defined
***************************************************************************/
int BpGetWanSfpLinkFailLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usWanSfpLinkFailLed, pusValue ) );
}
/**************************************************************************
* Name       : BpGetWifiLedGpio
*
* Description: This function returns the GPIO pin assignment for the Wifi
*              LED.
*
* Parameters : [OUT] pusValue - Address of short word that the Wifi LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
...
*                  for the board.
***************************************************************************/
int BpGetWifiLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedWifi, pusValue ) );
} /* BpGetWifiLedGpio */

/**************************************************************************
* Name       : BpGetWififailLedGpio
*
* Description: This function returns the GPIO pin assignment for the Wifi Fail
*              LED.
*
* Parameters : [OUT] pusValue - Address of short word that the Wifi Fail LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
...
*                  for the board.
***************************************************************************/
int BpGetWifiFailLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedWifiFail, pusValue ) );
} /* BpGetWifiFailLedGpio */

#if defined(GPL_CODE_INTERNET_LED_BEHAVIOR)
/**************************************************************************
* Name       : BpGetInternetGreedLedGpio
*
* Description: This function returns the GPIO pin assignment for
*              Internet Green LED
*
*
* Parameters : [OUT] pusValue - Address of short word that the Internet Greed LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
...
*                  for the board.
***************************************************************************/
int BpGetInternetGreenLedGpio( unsigned short *pusValue )
{
    return(BpGetGpio(bp_usGpioInternetGreenLed, pusValue));
}

/**************************************************************************
* Name       : BpGetInternetRedLedGpio
*
* Description: This function returns the GPIO pin assignment for
*              Internet Red LED
*
*
* Parameters : [OUT] pusValue - Address of short word that the Internet Red LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_BOARD_ID_NOT_SET - Error, BpSetBoardId has not been called.
...
*                  for the board.
***************************************************************************/
int BpGetInternetRedLedGpio( unsigned short *pusValue )
{
    return(BpGetGpio(bp_usGpioInternetRedLed, pusValue));
}
#endif

/**************************************************************************
* Name       : BpGetEth0Spd100LedGpio
*
* Description: This function returns the GPIO pin assignment for the Eth0 Speed 100
*              LED.
*                                                                                   
* Parameters : [OUT] pusValue - Address of short word that the Eth0 Speed 100 LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_VALUE_NOT_DEFINED - At least one return value is not defined
*                  for the board.
***************************************************************************/
int BpGetEth0Spd100LedGpio( unsigned short *pusValue )
{
    const ETHERNET_MAC_INFO *pE = NULL;

    pE = BpGetEthernetMacInfoArrayPtr()+1;
    if(!pE){
        return BP_VALUE_NOT_DEFINED;
    }
    *pusValue = pE->sw.ledInfo[0].speedLed100;
    return BP_SUCCESS ;
}

/**************************************************************************
* Name       : BpGetEth0Spd1000LedGpio
*
* Description: This function returns the GPIO pin assignment for the Eth0 Speed 1000
*              LED.
*
* Parameters : [OUT] pusValue - Address of short word that the Eth0 Speed 1000 LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_VALUE_NOT_DEFINED - At least one return value is not defined
*                  for the board.
***************************************************************************/
int BpGetEth0Spd1000LedGpio( unsigned short *pusValue )
{
    const ETHERNET_MAC_INFO *pE = NULL;
    ...
    *pusValue = pE->sw.ledInfo[0].speedLed1000;
    return BP_SUCCESS ;
}


/**************************************************************************
* Name       : BpGetEth1Spd100LedGpio
*
* Description: This function returns the GPIO pin assignment for the Eth1 Speed 100
*              LED.
*
* Parameters : [OUT] pusValue - Address of short word that the Eth1 Speed 100 LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_VALUE_NOT_DEFINED - At least one return value is not defined
*                  for the board.
***************************************************************************/
int BpGetEth1Spd100LedGpio( unsigned short *pusValue )
{
    const ETHERNET_MAC_INFO *pE = NULL;
    ...
    *pusValue = pE->sw.ledInfo[1].speedLed100;
    return BP_SUCCESS ;
}

/**************************************************************************
* Name       : BpGetEth1Spd1000LedGpio
*
* Description: This function returns the GPIO pin assignment for the Eth1 Speed 1000
*              LED.
*
* Parameters : [OUT] pusValue - Address of short word that the Eth1 Speed 1000 LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_VALUE_NOT_DEFINED - At least one return value is not defined
*                  for the board.
***************************************************************************/
int BpGetEth1Spd1000LedGpio( unsigned short *pusValue )
{
    const ETHERNET_MAC_INFO *pE = NULL;
    ...
    *pusValue = pE->sw.ledInfo[1].speedLed1000;
    return BP_SUCCESS ;
}


/**************************************************************************
* Name       : BpGetEth2Spd100LedGpio
*
* Description: This function returns the GPIO pin assignment for the Eth2 Speed 100
*              LED.
*
* Parameters : [OUT] pusValue - Address of short word that the Eth2 Speed 100 LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_VALUE_NOT_DEFINED - At least one return value is not defined
*                  for the board.
***************************************************************************/
int BpGetEth2Spd100LedGpio( unsigned short *pusValue )
{
    const ETHERNET_MAC_INFO *pE = NULL;
    ...
    *pusValue = pE->sw.ledInfo[2].speedLed100;
    return BP_SUCCESS ;
}

/**************************************************************************
* Name       : BpGetEth2Spd1000LedGpio
*
* Description: This function returns the GPIO pin assignment for the Eth2 Speed 1000
*              LED.
*
* Parameters : [OUT] pusValue - Address of short word that the Eth2 Speed 1000 LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_VALUE_NOT_DEFINED - At least one return value is not defined
*                  for the board.
***************************************************************************/
int BpGetEth2Spd1000LedGpio( unsigned short *pusValue )
{
    const ETHERNET_MAC_INFO *pE = NULL;
    ...
    *pusValue = pE->sw.ledInfo[2].speedLed1000;
    return BP_SUCCESS ;
}


/**************************************************************************
* Name       : BpGetEth3Spd100LedGpio
*
* Description: This function returns the GPIO pin assignment for the Eth3 Speed 100
*              LED.
*
* Parameters : [OUT] pusValue - Address of short word that the Eth3 Speed 100 LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_VALUE_NOT_DEFINED - At least one return value is not defined
*                  for the board.
***************************************************************************/
int BpGetEth3Spd100LedGpio( unsigned short *pusValue )
{
    const ETHERNET_MAC_INFO *pE = NULL;
    ...
    *pusValue = pE->sw.crossbar[4].ledInfo.speedLed100;
    return BP_SUCCESS ;
}

/**************************************************************************
* Name       : BpGetEth3Spd1000LedGpio
*
* Description: This function returns the GPIO pin assignment for the Eth3 Speed 1000
*              LED.
*
* Parameters : [OUT] pusValue - Address of short word that the Eth3 Speed 1000 LED
*                  GPIO pin is returned in.
*
* Returns    : BP_SUCCESS - Success, value is returned.
*              BP_VALUE_NOT_DEFINED - At least one return value is not defined
*                  for the board.
***************************************************************************/
int BpGetEth3Spd1000LedGpio( unsigned short *pusValue )
{
    const ETHERNET_MAC_INFO *pE = NULL;
    ...
    *pusValue = pE->sw.crossbar[4].ledInfo.speedLed1000;
    return BP_SUCCESS ;
}

int BpisWPSLEDGPIO(int index)
{
    int res = 0;

    if (bpLedList[index] == bp_usGpioLedSesWireless || bpLedList[index] == bp_usGpioLedSesWirelessFail)
        res = 1;
...
#if defined(GPL_CODE_INTERNET_LED_BEHAVIOR)
int BpisInternetLEDGPIO(int index)
{
    int res = 0;

    if (bpLedList[index] == bp_usGpioInternetGreenLed || bpLedList[index] == bp_usGpioInternetRedLed)
        res = 1;
...
***************************************************************************/
int BpGetLedName(int idx, int* token,  unsigned short *pusValue, char **ledName)
{
