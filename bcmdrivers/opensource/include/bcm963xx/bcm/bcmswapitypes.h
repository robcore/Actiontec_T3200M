...
#if defined(GPL_CODE_HPNA) && defined(GPL_CODE_WT107)
...
#if defined(CONFIG_BCM963138) || defined(CONFIG_BCM963148) || defined(CHIP_63138) || defined(CHIP_63148)
...
#define AUTONEG_RESTART_MASK 0x02
        ...
        struct emac_stats
        {
            ...
            unsigned long long rx_frame_1519_mtu;   /**< Receive 1519 to MTU  Frame Counter */
            ...
            unsigned long long rx_control_frame;     /**< Receive Control Frame Counter */
            unsigned long long rx_pause_control_frame;/**< Receive Pause Control Frame */
            unsigned long long rx_unknown_opcode;    /**< Receive Unknown opcode */
            ...
            unsigned long long tx_frame_1519_mtu;   /**< Transmit 1519 to MTU Frame Counter */
            ...
            unsigned long long tx_excessive_collision; /**< Transmit Excessive collision counter */
            unsigned long long tx_late_collision;    /**< Transmit Late collision counter */
            unsigned long long tx_single_collision;  /**< Transmit Single collision frame counter */
            unsigned long long tx_multiple_collision;/**< Transmit Multiple collision frame counter */
            unsigned long long tx_pause_control_frame; /**< Transmit PAUSE Control Frame */
            unsigned long long tx_deferral_packet;   /**< Transmit Deferral Packet */
            unsigned long long tx_excessive_deferral_packet; /**< Transmit Excessive Deferral Packet */
            unsigned long long tx_control_frame;     /**< Transmit Control Frame */
        }emac_stats_s; 
...
#define METER_TYPE_MULTICAST 3 /*correspond to rdpa_cpu_rx_reason_mcast*/
       ...
       {
           unsigned long long rx_valid_pkt;               /**< Valid Received packets */
           unsigned long long rx_crc_error_pkt;           /**< Received packets with CRC error */
           unsigned long long rx_discard_1;               /**< RX discard 1 */
           unsigned long long rx_discard_2;               /**< RX discard 2 */
           unsigned long long bbh_drop_1;                 /**< BBH drop 1 */
           unsigned long long bbh_drop_2;                 /**< BBH drop 2 */
           unsigned long long bbh_drop_3;                 /**< BBH drop 3 */
           unsigned long long rx_discard_max_length;      /**< Packets discarded due to size bigger than MTU  */
           unsigned long long rx_discard_min_length;      /**< Packets discarded due to size smaller than 64  */
           unsigned long long tx_valid_pkt;               /**< Valid transmitted packets */
           unsigned long long tx_discard;                 /**< TX discarded packets (TX FIFO full) */
           unsigned long long discard_pkt;                /**< Dropped filtered Packets */
        } rdpa_port_stats_s;
        struct oam_idx_str
        {
