...
#if defined(GPL_CODE_SUPPORT_SFP_TR98_VENDOR_EXTENSIONS)
#define LASER_IOCTL_GET_VENDOR_NAME  _IOR   (LASER_IOC_MAGIC, 11, LASER_OPTICAL_PARAMS)
#define LASER_IOCTL_GET_VENDOR_REV   _IOR   (LASER_IOC_MAGIC, 12, LASER_OPTICAL_PARAMS)
#define LASER_IOCTL_GET_SN           _IOR   (LASER_IOC_MAGIC, 13, LASER_OPTICAL_PARAMS)
#define LASER_IOCTL_GET_PN           _IOR   (LASER_IOC_MAGIC, 14, LASER_OPTICAL_PARAMS)
#define LASER_IOCTL_GET_VENDOR_OUI   _IOR   (LASER_IOC_MAGIC, 15, LASER_OPTICAL_PARAMS)
#endif
