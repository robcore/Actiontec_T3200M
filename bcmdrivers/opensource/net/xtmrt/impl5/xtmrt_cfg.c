...
#if defined(CONFIG_BCM96318) || defined(CONFIG_BCM963268) || defined(CONFIG_BCM963381)
#include "bcmPktDma.h"
#include "xtmrt_dma.h"
#else
...
/*---------------------------------------------------------------------------
 * struct net_device_stats *bcmxtmrt_query(struct net_device *dev)
 * Description:
