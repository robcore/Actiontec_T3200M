...
int bdmf_new_and_set(bdmf_type_handle drv,
             bdmf_object_handle owner, const bdmf_mattr_handle hmattr,
             bdmf_object_handle *pmo);
 ...
 *                      The set is released automatically if the function
 *                      is successful (returns 0).\n
 *                      The set is NOT released if function fails
 *                      (return code != 0)
 * \return
 *     0      - OK \n
 *    <0      - error
 */
int bdmf_mattr_set(bdmf_object_handle mo, const bdmf_mattr_handle mattr);
