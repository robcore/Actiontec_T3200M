...
static int kerSysBcmSpiSlaveRead_rev0(int dev, unsigned long addr, unsigned long *data, unsigned long len);
static int kerSysBcmSpiSlaveWrite_rev0(int dev, unsigned long addr, unsigned long data, unsigned long len);
static int kerSysBcmSpiSlaveWriteBuf_rev0(int dev, unsigned long addr, unsigned long *data, unsigned long len, unsigned int unitSize);

static int kerSysBcmSpiSlaveReset_rev1(int dev);
static int kerSysBcmSpiSlaveInit_rev1(int dev);
static int kerSysBcmSpiSlaveRead_rev1(int dev, unsigned long addr, unsigned long *data, unsigned long len);
static int kerSysBcmSpiSlaveWrite_rev1(int dev, unsigned long addr, unsigned long data, unsigned long len);
static int kerSysBcmSpiSlaveWriteBuf_rev1(int dev, unsigned long addr, unsigned long *data, unsigned long len, unsigned int unitSize);

static int kerSysBcmSpiSlaveReset_rev2(int dev);
static int kerSysBcmSpiSlaveInit_rev2(int dev);
static int kerSysBcmSpiSlaveRead_rev2(int dev, unsigned long addr, unsigned long *data, unsigned long len);
static int kerSysBcmSpiSlaveWrite_rev2(int dev, unsigned long addr, unsigned long data, unsigned long len);
static int kerSysBcmSpiSlaveWriteBuf_rev2(int dev, unsigned long addr, unsigned long *data, unsigned long len, unsigned int unitSize);

static void getSpiSlaveDeviceInfo( void );

typedef int (*spiSlaveReset)(int dev);
typedef int (*spiSlaveInit)(int dev);
typedef int (*spiSlaveRead)(int dev, unsigned long addr, unsigned long *data, unsigned long len);
typedef int (*spiSlaveWrite)(int dev, unsigned long addr, unsigned long data, unsigned long len);
typedef int (*spiSlaveWriteBuf)(int dev, unsigned long addr, unsigned long *data, unsigned long len, unsigned int unitSize);
...
static int rev2_add_command_and_address_to_buffer(uint8_t *buf,
        spi_command_rev2 cmd, unsigned long addr)
{
    buf[0] = cmd;
    buf[1] = addr >> 8;
    buf[2] = addr & 0xff;
...
static int kerSysBcmSpiSlaveWriteBuf_rev2(int dev, unsigned long addr, unsigned long *data, unsigned long len, unsigned int unitSize)
{
    ...
    buf[3] = (uint8_t) ((*data >> 24) & 0xff);  // single byte write for now
