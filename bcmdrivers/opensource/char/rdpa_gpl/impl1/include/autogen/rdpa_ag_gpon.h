...
typedef enum {
    ...
    rdpa_gpon_attr_rogue_onu = 17, /* rogue_onu : RW : aggregate/16 rogue_onu(rdpa_rogue_onu_t) : rogue onu */
    ...
    rdpa_gpon_attr_gem_ds_cfg = 20, /* gem_ds_cfg : RWF : aggregate/9[256(object)] gem_ds_cfg(rdpa_gpon_gem_ds_cfg_t) : Downstream GEM configuration */
