...
typedef enum {
    ...
    rdpa_port_attr_cfg = 2, /* cfg : RW : aggregate/20 port_dp(rdpa_port_dp_cfg_t) : Logical port configuration */
    rdpa_port_attr_tm_cfg = 3, /* tm_cfg : RW : aggregate/12 port_tm(rdpa_port_tm_cfg_t) : TM configuration */
    ...
    rdpa_port_attr_stat = 6, /* stat : RW : aggregate/48 stat(rdpa_port_stat_t) : Port statistics */
