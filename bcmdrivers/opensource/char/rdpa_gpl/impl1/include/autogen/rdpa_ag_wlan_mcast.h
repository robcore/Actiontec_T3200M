...
typedef enum {
    rdpa_wlan_mcast_attr_fwd_table_entries = 0, /* fwd_table_entries : R : number/4 : Number of configured Forwarding Table entries */
    rdpa_wlan_mcast_attr_fwd_table = 1, /* fwd_table : RWADF : aggregate/84[64] fwd_table_entry(rdpa_wlan_mcast_fwd_table_t) : Forwarding Table */
    rdpa_wlan_mcast_attr_dhd_station_entries = 2, /* dhd_station_entries : R : number/4 : Number of configured DHD Stations */
    rdpa_wlan_mcast_attr_dhd_station = 3, /* dhd_station : RWADF : aggregate/12[64] dhd_station_entry(rdpa_wlan_mcast_dhd_station_t) : DHD Station Table */
    rdpa_wlan_mcast_attr_ssid_mac_address_entries = 4, /* ssid_mac_address_entries : R : number/4 : Number of configured SSID MAC Addresses */
    rdpa_wlan_mcast_attr_ssid_mac_address = 5, /* ssid_mac_address : RWADF : aggregate/9[48] ssid_mac_address_entry(rdpa_wlan_mcast_ssid_mac_address_t) : SSID MAC Address Table */
    rdpa_wlan_mcast_attr_ssid_stats = 6, /* ssid_stats : RF : aggregate/12[48] ssid_stats_entry(rdpa_wlan_mcast_ssid_stats_t) : SSID Statistics */
