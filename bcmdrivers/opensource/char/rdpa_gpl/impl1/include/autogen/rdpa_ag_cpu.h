...
typedef enum {
    ...
    rdpa_cpu_attr_rxq_cfg = 2, /* rxq_cfg : RWF : aggregate/32[12] cpu_rxq_cfg(rdpa_cpu_rxq_cfg_t) : Receive queue configuration */
    rdpa_cpu_attr_rxq_flush = 3, /* rxq_flush : W : bool/1[12] : Flush receive queue */
    rdpa_cpu_attr_rxq_stat = 4, /* rxq_stat : RF : aggregate/16[12] cpu_rx_stat(rdpa_cpu_rx_stat_t) : Rx statistics */
    ...
    rdpa_cpu_attr_reason_stat_external_cb = 9, /* reason_stat_external_cb : W : pointer/4 : Reason statistics external callback */
} rdpa_cpu_attr_types;
