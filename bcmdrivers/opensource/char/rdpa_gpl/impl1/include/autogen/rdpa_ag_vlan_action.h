...
typedef enum {
    rdpa_vlan_action_attr_dir = 0, /* dir : MKRI : enum/4 : Traffic Direction */
    rdpa_vlan_action_attr_index = 1, /* index : KRI : number/4 : VLAN Action Index */
    rdpa_vlan_action_attr_action = 2, /* action : RW : aggregate/16 vlan_action(rdpa_vlan_action_cfg_t) : Action and parameters */
