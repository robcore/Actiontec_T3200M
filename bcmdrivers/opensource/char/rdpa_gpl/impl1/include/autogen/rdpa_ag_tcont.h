...
typedef enum {
    ...
    rdpa_tcont_attr_egress_tm = 2, /* egress_tm : RW : object/4 : US scheduler object */
    rdpa_tcont_attr_enable = 3, /* enable : RW : bool/1 : Enable TCONT */
    rdpa_tcont_attr_orl_prty = 4, /* orl_prty : RW : enum/4 : Priority for overall rate limiter */
