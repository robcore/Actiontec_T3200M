...
typedef enum {
    ...
    rdpa_iptv_attr_iptv_stat = 2, /* iptv_stat : RW : aggregate/12 iptv_stat(rdpa_iptv_stat_t) : IPTV global statistics */
    rdpa_iptv_attr_channel_request = 3, /* channel_request : WAD : aggregate/110 iptv_channel_request(rdpa_iptv_channel_request_t) : Request to view the channel (reflect */
    rdpa_iptv_attr_channel = 4, /* channel : RF : aggregate/122[1024] iptv_channel(rdpa_iptv_channel_t) : IPTV channels table */
