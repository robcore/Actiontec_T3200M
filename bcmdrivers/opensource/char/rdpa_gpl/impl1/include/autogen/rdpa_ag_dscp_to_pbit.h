...
typedef enum {
    rdpa_dscp_to_pbit_attr_table = 0, /* table : KRI : number/4 : Table index */
    rdpa_dscp_to_pbit_attr_qos_mapping = 1, /* qos_mapping : RI : bool/1 : Yes : qos mapping table, no : vlan action per port table */
    rdpa_dscp_to_pbit_attr_dscp_map = 2, /* dscp_map : RWF : number/1[64] : DSCP PBIT array */
