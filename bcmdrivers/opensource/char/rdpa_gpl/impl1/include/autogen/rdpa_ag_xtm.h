...
/* xtm: Attribute types */
typedef enum {
    rdpa_xtm_attr_index = 0, /* index : R : number/4 : XTM Index */
} rdpa_xtm_attr_types;
...
typedef enum {
    rdpa_xtmchannel_attr_index = 0, /* index : KRI : number/4 : XTMCHANNEL index */
    rdpa_xtmchannel_attr_egress_tm = 1, /* egress_tm : RW : object/4 : US scheduler object */
    rdpa_xtmchannel_attr_enable = 2, /* enable : RW : bool/1 : Enable XTMCHANNEL */
    rdpa_xtmchannel_attr_orl_prty = 3, /* orl_prty : RW : enum/4 : Priority for overall rate limiter */
...
typedef enum {
    rdpa_xtmflow_attr_index = 0, /* index : KRI : number/4 : xtmflow index */
    rdpa_xtmflow_attr_fstat = 1, /* fstat : MRI : number/2 : xtmflow fstat */
    rdpa_xtmflow_attr_us_cfg = 2, /* us_cfg : RW : aggregate/4 xtmflow_us_cfg(rdpa_xtmflow_us_cfg_t) : US configuration */
    rdpa_xtmflow_attr_stat = 3, /* stat : R : aggregate/12 xtmflow_stat(rdpa_xtmflow_stat_t) : xtmflow statistics */
    rdpa_xtmflow_attr_ptmBonding = 4, /* ptmBonding : MRI : number/4 : xtmflow ptmBonding */
