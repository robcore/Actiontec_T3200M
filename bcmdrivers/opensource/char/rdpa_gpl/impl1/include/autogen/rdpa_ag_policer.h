...
typedef enum {
    rdpa_policer_attr_dir = 0, /* dir : MKRI : enum/4 : Traffic Direction */
    rdpa_policer_attr_index = 1, /* index : KRI : number/4 : Policer Index */
    rdpa_policer_attr_cfg = 2, /* cfg : RW : aggregate/16 tm_policer_cfg(rdpa_tm_policer_cfg_t) : Configuration */
    rdpa_policer_attr_stat = 3, /* stat : R : aggregate/8 tm_policer_stat(rdpa_tm_policer_stat_t) : Statistics */
