...
#if defined(DSL_63138) || defined(DSL_63148) || defined(CONFIG_BCM963138) || defined(CONFIG_BCM963148)
#define GBE_WAN_FLOW_ID 239 /* not used by DSL WAN Mode */
#else
...
typedef enum
{
    RDPA_WL_ACCEL_NONE = 0,
    RDPA_WL_ACCEL_WFD,
    RDPA_WL_ACCEL_DHD_OFFLOAD
} rdpa_wl_accel_t;
