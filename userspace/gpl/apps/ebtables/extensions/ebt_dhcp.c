   ...
   unsigned int hookmask, unsigned int time)
{
	...
	if (BASE_CHAIN && dhcpinfo->target == EBT_RETURN)
		print_error("--dhcp-target RETURN not allowed on base chain");
}
