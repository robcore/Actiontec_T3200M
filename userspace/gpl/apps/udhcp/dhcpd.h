...
#if defined(GPL_CODE)
#if defined(GPL_CODE)
#define IPTV_STB_STR           "KineticTV"
#elif defined(GPL_CODE_T3200)
#define IPTV_STB_STR           "TDSTV"
#else
#define IPTV_STB_STR           "OptikTV"
#endif
#endif
/************************************/
...
#if  defined(GPL_CODE) || defined(GPL_CODE_DHCP_OPTION67)
...
#define DHCP_TFTP_SERVER    0x42
#endif
#ifdef GPL_CODE_DHCP_OPTION120
#define DHCP_SIP_SERVER    0x78
#endif
...
#define DHCPINFORM		8
#if defined(GPL_CODE_DHCPFORCERENEW)
...
extern unsigned int reduce_lease_time;
extern unsigned long select_begin_time;
#endif
...
#endif
/***Add by sunny for option 60; 2014-06-11**/
#if defined(GPL_CODE_DHCP_OPTION60)
    char *option60Vids[VENDOR_CLASS_ID_TAB_SIZE];
#endif
/************End***************/
