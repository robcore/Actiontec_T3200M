...
/** Get the MdmObjectId of the specified object.
 * 
 * The MdmObjectId is embedded in the first half word (16 bits) in every MdmObject.
 */
...
/** Instance number for Cellular WANDevice */
#define CMS_WANDEVICE_CELLULAR   8
