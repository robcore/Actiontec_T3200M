 ...
 *
 */
#if defined(GPL_CODE_PASSWORD_ENCRYPTION)
...
#elif defined(GPL_CODE)||defined(GPL_CODE)
...
#define TR69_MONITOR_PORT        30006
#endif
...
#if defined(DNS_PROBE) && defined(GPL_CODE_DNS_PROBE)
