...
typedef enum {
   ...
   EID_DETECT_WAN_SERVICE=5002,
#endif
#if defined (GPL_CODE_DETECT_WAN_SERVICE)
   EID_SET_DETECT_WAN_SERVICE=5003,
#endif
   ...
   EID_INHPNA=5008,
   EID_NETPERD=5009,
#ifdef GPL_CODE_WT107
   EID_HPNA_NODESTATS=5010,
#endif
#endif
#if defined(GPL_CODE_SMARTLED)
   EID_SMARTLED=5011,
#endif
#if defined(GPL_CODE_SMARTLED)  || defined (GPL_CODE)
   EID_NSLOOKUP=5012,
#endif
   ...
   EID_SAVESYSLOG=5017,
#endif
#if defined(GPL_CODE_NTPV4)
   EID_NTPV4=5018,
#endif
#if defined(GPL_CODE_HPNA_NETINF_DIAG)
    EID_NETINF=5019,
#endif
#if defined (GPL_CODE_CES)
   EID_CES=5020,
#endif
#if defined(GPL_CODE)
   EID_STATISTICS_COLLECT=5021,
#endif
#ifdef GPL_CODE_CONTROL_PING6
    EID_PING6=5022,
#endif
#ifdef GPL_CODE_CONTROL_TRACEROUTE6
    EID_TRACEROUTE6=5023,
#endif
#if defined(GPL_CODE_CPU_SYSLOG)
    EID_CPULOGD=5024,
#endif
    ...
    EID_CLI=5027,
    EID_WGET=5028,
#if defined(GPL_CODE_TR181_WLMNGR) || defined(GPL_CODE_SUPPORT_WIFI_181)
   EID_WIFI_NEIGHBOR_DIAG=5029,
#endif
#endif
#ifdef GPL_CODE_COMMUNITY_WIFI
   EID_MYGRE=5030,
#endif
#if defined(GPL_CODE_DUMPMDM)
   EID_DUMPMDM=5032,
#endif
#if defined(GPL_CODE_DUMPCFG)
   EID_DUMPCFG=5033,
#endif
   EID_DMADAPTER_LIB=9998,
   ...
   EID_RESERVED=10000,   /* keep EID's >= 10000 reserved for future use */
    ...
    EID_SCKIPIOCTL=5031,
#endif
#if defined(GPL_CODE_TR69_MONITOR)
    EID_TR69_MONITOR=5034,
#endif
EID_LAST=65535
} CmsEntityId;
