...
#endif
#ifdef GPL_CODE_CONTROL_TR143_IPV6
...
#endif
#if defined(GPL_CODE)
  USER_REMOTE_CREDENTIALS_CHANGED,
#endif
} UserChangedType;
...
#if defined(GPL_CODE_AUTO_RELAUNCH_DHCPC)
#define AEISYNCDHCPCPIDFILE "/var/syncdhcpcpid"
#endif
...
#define EWANL2INTF_1  "ewan0.1"
#define SFP_L3IFNAME  "ewan1.31"
...
#define AEI_CMS_MSG_SOCKET_SNDBUF      (184*1024*2)
#define AEI_CMS_MSG_SOCKET_RCVBUF      (184*1024*2)
#define AEI_CMS_MSG_SOCKET_SNDTIMEO     (10 * 1000)
#define AEI_CMS_MSG_SOCKET_RCVTIMEO     (10 * 1000)

extern int set_socket_opt(int fd, int opt, int value);
#endif

#if defined(GPL_CODE_CMS_MSG_NOBLOCK)
#define CMS_MSG_BLOCK_LOG "/var/cms_msg_block_log"
#define MAX_CMS_MSG_LOG                (1*1024*1024) /*1M*/
#define AEI_CMS_MSG_NOBLOCK_SNDTIMEO   (10)
#define AEI_CMS_MSG_DEFAULT_SNDTIMEO   (30 * 1000)
#define AEI_CMS_MSG_NOBLOCK_RCVTIMEO   (10)
#define AEI_CMS_MSG_DEFAULT_RCVTIMEO   (300 * 1000)
#endif
