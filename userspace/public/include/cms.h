...
typedef enum
{
   ...
   CMSRET_WRONG_IMAGE = 9860  /** image for wrong platform*/
#endif
#endif
...
#define BUFLEN_160      160   //!< buffer length 160
...
#if defined(SUPPORT_IPV6) || defined(GPL_CODE_CONTROL_LAYER)
...
#define EWAN_IFC_STR          "ewan"
   ...
   #if defined(GPL_CODE_LAN_SUBNET_5G) || defined(GPL_CODE_PUBLIC_WIFI)
     #define AEI_5G_WIFI_DEV_NAME "eth4"
   #endif
   #define INTERFACE_NAME_FOR_QTN "eth4.0"
  #else
   #define INTERFACE_NAME_FOR_QTN "eth4"
  #endif
   #define QTN_STATUS_FILE "/var/has_qtn"    /* used to indicate QTN card */
  #else
   #define INTERFACE_NAME_FOR_QTN "host0"
  #endif
#endif
 ...
 #if defined(GPL_CODE_QTN_WIRELESS_RGMII)
  #ifdef SUPPORT_LANVLAN
   #define ACTION_TEC_QTN_IFNAME      "eth4.0"
  #else
   #define ACTION_TEC_QTN_IFNAME      "eth4"
  #endif
 #else
  #define ACTION_TEC_QTN_IFNAME      "host0"
 #endif
#endif
...
#if defined(GPL_CODE) || defined(GPL_CODE_UPGRADE_MEM_CHECK)
#define SZ_1KB 1024
#endif
#if defined(GPL_CODE_UPGRADE_MEM_CHECK)
#define FN_NEED_REBOOT "/var/needReboot"
#endif

#if defined(GPL_CODE_CONSOLE_SECURITY_MODE)
#if defined(GPL_CODE)
#define AEI_CONSOLE_SEC_MODE_DEF 1
#else
#define AEI_CONSOLE_SEC_MODE_DEF 0
#endif
#endif

#ifdef GPL_CODE
#define RG_HSI_STRING "RG_HSI_"
#define RG_IPTV_STRING "RG_IPTV_"
#endif
...
#ifdef GPL_CODE_PC_PAUSE_INTERNET
/* 1 = pauseInternet enabled only
   2 = pauseInternet enabled and pausedAll
*/
#define PAUSE_INTERNET_EN 1
#define PAUSE_INTERNET_ALL 2
#define FN_PAUSE_INTERNET_FLAG "/var/pauseInternetFlag"
#if AEI_RESOLVE_DOMAIN_TO_IP
#define STR_NOWAN_TO_GETIP "NOWAN_TO_GETIP"
#endif
#define STR_PAUSE_INTERNET "pauseInternet"
#define DEF_LANIP "192.168.1.254"
#endif
