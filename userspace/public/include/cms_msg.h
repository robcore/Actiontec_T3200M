...
#ifdef GPL_CODE_MOCA_LINK_EVENT
...
#endif
#if defined(GPL_CODE_DETECT_WAN_SERVICE) || defined(GPL_CODE_TELUS_DETECT_WAN_SERVICE)
...
#endif
//#if defined(GPL_CODE) || defined(GPL_CODE_TR098_QWEST) || defined(GPL_CODE)
#if defined(GPL_CODE)
...
#ifdef GPL_CODE_CONTROL_LAYER
#ifdef GPL_CODE_SUPPORT_IPV6_STATICROUTE
    CMS_MSG_AEI_CTL_INFOR_FOR_STATIC_ROUTE   = 0x10002664,
#endif
    CMS_MSG_AEI_CTL_GET_PHYTYPE_IFNAME       = 0x10002667,
#endif
#if defined(GPL_CODE) || defined(GPL_CODE_DHCP_AUTO_RESERVATION)
   CMS_MSG_SELECT_VALID_RESERVATION                = 0x10002669,
#endif
#if defined(GPL_CODE_SUPPORT_VOIP_PRE_REGISTER)
...
#endif
#if defined(GPL_CODE_TELUS_DETECT_WAN_SERVICE)
   CMS_MSG_TELUS_DETECT_WAN_SERVICE                   = 0x10002672,
#endif
#if defined(GPL_CODE_HPNA_NETINF_DIAG)
   CMS_MSG_NETINF_RESULT                           = 0x10002673,
#endif
#if defined(GPL_CODE_ADVANCED_WL_STATISTICS)
...
#ifdef GPL_CODE_TR069_WIFI_INIT
   ...
   CMS_MSG_GET_SCKIPIO_CONFIG           = 0x2000000C,
   CMS_MSG_SET_SCKIPIO_CONFIG           = 0x2000000D,
   CMS_MSG_REMOVE_GFAST_MODULE          = 0x2000000E,
#endif

#if defined(GPL_CODE_TR181_WLMNGR)
#if defined(GPL_CODE_QTN_RGMII_RELOAD)
   CMS_MSG_QTN_RGMII_RELOAD              = 0x2000000F,
#endif
#endif
#ifdef GPL_CODE_SUPPORT_SCHEDULING_ACCESS_EXTEND
   CMS_MSG_NEED_UPDATE_SCHEDULING_ACCESS      = 0x20000010,  /*Send this to ssk to update scheduling access configure*/
#endif
#if defined(GPL_CODE_TELUS_CALL_CENTER)
   CMS_MSG_WAN_IP_RELEASE_RENEW         = 0x20000011,
#endif
#if defined(GPL_CODE_ENABLE_PROFILE_LOG)
   CMS_MSG_SET_PROFILE_LOG_LEVEL        = 0x20000020,
#endif
...
typedef struct
{
   ...
   char acsUser[BUFLEN_256];
   char acsPassword[BUFLEN_256];
#endif
#if defined(GPL_CODE)
   UINT32 ledControl;
#endif
//#if defined(GPL_CODE)
#if defined(GPL_CODE_DHCP_WAN_LEASETIME) //modify william 2011-11-29
...
#endif
#if defined(GPL_CODE_QOS)
    char clsname[BUFLEN_128];      /** Option 60 string for qos classification*/
    char macs[BUFLEN_128];
    char option60String[BUFLEN_256];
#endif
...
#if defined(GPL_CODE) && defined(GPL_CODE_MYNETWORK)
/*
 * This message is used for CMS_MSG_SSK_HOST_ACTIVE
 * when Physical interface up/down, ssk will notify mynetwork to update related
 * hosts active status
 * down or up
 * The only parameters needed are MAC address and status
 *
 * Use this message boy istead of DhcpdHostInfoMsgBody to reduce resource usage
 */
typedef struct
{
   UBOOL8 active;                  /** the host is active or not , same value as */
