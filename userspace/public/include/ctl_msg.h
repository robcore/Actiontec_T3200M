...
#ifdef GPL_CODE_SUPPORT_6RD
    CTL_MSG_WATCH_6RD_OPTION = 0x10002409,
#endif
#ifdef GPL_CODE_CONTROL_LAYER_DAD
    CTL_MSG_WATCH_DAD_RESULT = 0x10002410,
#endif
#ifdef DMP_SIMPLEFIREWALL_1
//   CTL_MSG_TR69_FIREWALL_LEVEL_CHANGED = 0x10002500, /* tr69c -> httpd */
#endif
#ifdef GPL_CODE_SUPPORT_LAN_FIREWALL
   CTL_MSG_SET_LAN_DEFAULT_FIREWALL = 0x10002411,  
#endif
#ifdef GPL_CODE_SUPPORT_SERVICE_BLOKING_EXTEND
   CTL_MSG_SET_SERV_BLOCKING = 0x10002412,
#endif
#ifdef GPL_CODE 
   CTL_MSG_ACCESS_CFG_RESTORE = 0x10002408,
#endif 
#ifdef GPL_CODE
...
#ifdef GPL_CODE_SUPPORT_PHYTYPE_IFNAME_CHANGE
typedef struct {
