...
#if defined(CONFIG_BCM963138) || defined(CONFIG_BCM63381) || defined(CONFIG_BCM963148)
...
typedef struct XtmProcessorRegisters
{
    ...
    UINT32 ulSstMpPriArb;                                           /* 0200 */
    UINT32 ulSstVcPriArb;                                           /* 0204 */
    UINT32 ulSstLinkDownCount[XP_MAX_PORTS];                        /* 0208 */
    UINT32 ulSstUtopiaCfg;                                          /* 0218 */
    UINT32 ulSstRemapUtopiaCfg;                                     /* 021c */
    UINT32 ulSsPtmBondedPair;                                       /* 0220 */
    UINT32 ulSstDiagDMode;                                          /* 0224 */
    UINT32 ulSstSitValue;                                           /* 0228 */
    UINT32 ulSstSitSlowValue;                                       /* 022c */
    UINT32 ulSstMpQueueMask[XP_MAX_MP_GROUPS];                      /* 0230 */
    UINT32 ulSsMpGtsCfg[XP_MAX_MP_GROUPS];                          /* 0240 */
    UINT32 ulSsTxDmaEmpty;                                          /* 0250 */
    UINT32 ulSsPBufEmpty;                                           /* 0254 */
    UINT32 ulSsTxToRxPtmLinkStateMap;                               /* 0258 */
    UINT32 ulSsForceVcArbRR;                                        /* 025c */
    UINT32 ulSsForceMpArbRR;                                        /* 0260 */
    UINT32 ulSsDiagAdrMode;                                         /* 0264 */
    UINT32 ulSsNewCfgD0_or_Reserved6;                               /* 0268 */
    UINT32 ulReserved7[37];                                         /* 0268 */
    ...
    UINT32 ulReserved13;                                            /* 083c */
#else
    UINT32 ulReserved13[5];                                         /* 082c */
#endif
...
#define TXPAF_PROCESSOR_BASE    BCM_IO_ADDR(0x80656800)
