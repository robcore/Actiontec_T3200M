...
#ifndef GPL_CODE
   //fix compiler error, due to separate AEI obj/param from standard or broadcom data model, 
...
#if defined(SUPPORT_IPV6) || defined(GPL_CODE_CONTROL_LAYER) /* aka SUPPORT_IPV6 */
   if (af == AF_INET6)
   {
