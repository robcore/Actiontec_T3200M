 ...
 * Generation time: Mon Feb 18 12:40:13 2019
 */
#ifdef USE_MANUAL
...
"\n"
"       If you prefer a progress \"bar\" instead of the regular meter, [4m-#[24m is your\n"
"       friend.\n"
"\n"
"[1mOPTIONS[0m\n"
...
"              remote TLS server.  You can use  options  [4m--tlsv1.0[24m,  [4m--tlsv1.1[24m,\n"
, stdout);
 fputs(
"              and  [4m--tlsv1.2[24m to control the TLS version more precisely (if the\n"
...
"              [4m-H,[24m [4m--header[24m option of course.\n"
"\n"
...
"              combination with the [4m-L,[24m [4m--location[24m option. The file  format  of\n"
, stdout);
 fputs(
...
, stdout);
 fputs(
"              When used in conjunction with the [4m-o[24m option,  curl  will  create\n"
"              the  necessary  local directory hierarchy as needed. This option\n"
"              creates the dirs mentioned with the [4m-o[24m option, nothing else.  If\n"
"              the  [4m-o[24m file name uses no dir or if the dirs it mentions already\n"
...
, stdout);
 fputs(
"              [4m-d,[24m  [4m--data[24m  is  the  same  as [4m--data-ascii[24m. To post data purely\n"
"              binary, you should instead use the [4m--data-binary[24m option. To URL-\n"
"              encode the value of a form field you may use [4m--data-urlencode[24m.\n"
"\n"
...
"\n"
"              If you start the data with the letter @, the rest  should  be  a\n"
"              filename.   Data  is  posted in a similar manner as [4m--data-ascii[0m\n"
...
"\n"
"       --delegation LEVEL\n"
"              Set [4mLEVEL[24m to tell the server what it is allowed to delegate when\n"
...
"              [4m-u,[24m  [4m--user[24m  option  to  set  user  name  and password. See also\n"
, stdout);
 fputs(
...
"\n"
"              [1m--eprt [22mcan be used to explicitly enable EPRT again and [1m--no-eprt[0m\n"
"              is an alias for [1m--disable-eprt[22m.\n"
"\n"
, stdout);
 fputs(
...
"              not try using EPSV.\n"
"\n"
"              [1m--epsv [22mcan be used to explicitly enable EPSV again and [1m--no-epsv[0m\n"
"              is an alias for [1m--disable-epsv[22m.\n"
"\n"
...
, stdout);
 fputs(
"              This option is a counterpart  to  [4m--interface[24m  (which  does  not\n"
...
"              used with [4m-L,[24m [4m--location[24m you can append \";auto\" to the --referer\n"
...
"              nated! See [4m--cert[24m and [4m--key[24m to specify them independently.\n"
"\n"
...
, stdout);
 fputs(
"              Use  [4m--engine[24m  [4mlist[24m  to  print  a  list  of build-time supported\n"
"              engines. Note that not all (or  none)  of  the  engines  may  be\n"
"              available at run-time.\n"
"\n"
"       --environment\n"
"              (RISC  OS ONLY) Sets a range of environment variables, using the\n"
"              names the [4m-w[24m option supports, to allow easier extraction of use-\n"
...
"              override a previous [4m-P/-ftp-port[24m option. (Added in 7.11.0)\n"
"\n"
, stdout);
 fputs(
"              If  this  option  is  used  several times, only the first one is\n"
...
"              low the FTP transaction. The default mode is passive. See [4m--ftp-[0m\n"
"              [4mssl-ccc-mode[24m for other modes.  (Added in 7.16.1)\n"
"\n"
...
"              (HTTP)  Similar  to  [4m--form[24m except that the value string for the\n"
"              named parameter is used literally. Leading '@' and  '<'  charac-\n"
"              ters, and the ';type=' string in the value have no special mean-\n"
"              ing. Use this in preference to [4m--form[24m if there's any possibility\n"
, stdout);
 fputs(
"              that  the  string  value may accidentally trigger the '@' or '<'\n"
"              features of [4m--form[24m.\n"
"\n"
"       -g, --globoff\n"
...
, stdout);
 fputs(
"              fail unless [4m-k,[24m [4m--insecure[24m is used.\n"
"\n"
...
"\n"
"              When curl is invoked, it always (unless [4m-q[24m is used) checks for a\n"
...
"              effect if [4m--no-keepalive[24m is used. (Added in 7.18.0)\n"
"\n"
"              If this option is used several times, the last one will be used.\n"
...
"\n"
"       --key-type <type>\n"
"              (SSL) Private key file type. Specify which type your [4m--key[24m  pro-\n"
...
"              This is not very common. Use [4m-V,[24m [4m--version[24m to see if  your  curl\n"
"              supports it.\n"
"\n"
"              If this option is used several times, the last one will be used.\n"
"\n"
...
"\n"
"              Note: When combined with [4m-X,[24m [4m--request[24m  [4m<command>[24m,  this  option\n"
...
"              request on the new place. If used together with [4m-i,[24m [4m--include[24m or\n"
, stdout);
 fputs(
"              [4m-I,[24m [4m--head[24m, headers from all requested pages will be shown. When\n"
...
"\n"
"       --location-trusted\n"
"              (HTTP/HTTPS)  Like  [4m-L,[24m  [4m--location[24m,  but will allow sending the\n"
, stdout);
 fputs(
...
"              in decimal precision.  See also the [4m--connect-timeout[24m option.\n"
"\n"
"              If this option is used several times, the last one will be used.\n"
"\n"
, stdout);
...
"\n"
"       --max-redirs <num>\n"
"              Set  maximum  number  of  redirection-followings allowed. If [4m-L,[0m\n"
, stdout);
 fputs(
"              [4m--location[24m is used, this option can be used to prevent curl from\n"
...
, stdout);
 fputs(
"              note  that  if  [4m--metalink[24m  and  [4m--include[24m  are  used  together,\n"
"              [4m--include[24m  will be ignored. This is because including headers in\n"
...
"              user  authentication.  See [1mnetrc(4) [22mor [1mftp(1) [22mfor details on the\n"
...
"              thus use [4m--buffer[24m to enforce the buffering.\n"
"\n"
"       --netrc-file\n"
"              This option is similar to [4m--netrc[24m, except that you  provide  the\n"
"              path  (absolute  or relative) to the netrc file that Curl should\n"
"              use.  You can only specify one netrc  file  per  invocation.  If\n"
, stdout);
 fputs(
"              several  [4m--netrc-file[24m  options  are  provided, only the [1mlast one[0m\n"
"              will be used.  (Added in 7.21.5)\n"
"\n"
"              This option overrides any use of [4m--netrc[24m as  they  are  mutually\n"
"              exclusive.  It will also abide by [4m--netrc-optional[24m if specified.\n"
"\n"
"       --netrc-optional\n"
"              Very  similar to [4m--netrc[24m, but this option makes the .netrc usage\n"
, stdout);
 fputs(
"              [1moptional [22mand not mandatory as the [4m--netrc[24m option does.\n"
"\n"
"       --negotiate\n"
"              (HTTP) Enables Negotiate (SPNEGO) authentication.\n"
"\n"
"              If you want to enable Negotiate (SPNEGO) for  proxy  authentica-\n"
"              tion, then use [4m--proxy-negotiate[24m.\n"
"\n"
...
"\n"
"              Note that this is the negated option name  documented.  You  can\n"
"              thus use [4m--keepalive[24m to enforce keepalive.\n"
"\n"
"       --no-sessionid\n"
...
"\n"
"              Note that this is the negated option name  documented.  You  can\n"
"              thus use [4m--sessionid[24m to enforce session-ID caching.\n"
"\n"
...
"\n"
"              This option requires a library built with SSL support.  Use  [4m-V,[0m\n"
"              [4m--version[24m to see if your curl supports NTLM.\n"
"\n"
"              If  this  option  is  used  several times, only the first one is\n"
, stdout);
 fputs(
...
, stdout);
 fputs(
"              curl with the [1m-O, --remote-name [22mflag!\n"
"\n"
...
, stdout);
 fputs(
"              a  redirection.  This  option  is meaningful only when using [4m-L,[0m\n"
"              [4m--location[24m (Added in 7.17.1)\n"
"\n"
"       --post302\n"
"              (HTTP) Tells curl to respect RFC  2616/10.3.2  and  not  convert\n"
...
"              However, a server may require a POST to remain a POST after such\n"
"              a  redirection.  This  option  is meaningful only when using [4m-L,[0m\n"
"              [4m--location[24m (Added in 7.19.1)\n"
"\n"
"       --post303\n"
"              (HTTP) Tells curl to respect RFC  2616/10.3.2  and  not  convert\n"
...
"              However, a server may require a POST to remain a POST after such\n"
"              a  redirection.  This  option  is meaningful only when using [4m-L,[0m\n"
"              [4m--location[24m (Added in 7.26.0)\n"
"\n"
"       --proto <protocols>\n"
...
"\n"
"       -q     If used as the first parameter on the command line,  the  [4mcurlrc[0m\n"
...
"              engine for SSL connections.  See also the [4m--egd-file[24m option.\n"
"\n"
...
, stdout);
 fputs(
"              [4mall[24m  has  been  used,  you  must use \"-o -\" or [4m--no-remote-name[24m.\n"
"              (Added in 7.19.0)\n"
"\n"
...
"\n"
"       -S, --show-error\n"
"              When  used  with  [4m-s[24m  it  makes curl show an error message if it\n"
, stdout);
 fputs(
"              fails.\n"
"\n"
...
"\n"
"              This  option  was formerly known as [4m--ftp-ssl[24m (Added in 7.11.0).\n"
, stdout);
 fputs(
...
"              (Added in 7.20.0)\n"
"\n"
"              This  option  was  formerly  known  as  [4m--ftp-ssl-reqd[24m (added in\n"
...
"\n"
"              Examples:  --socks5  proxy-name  [4m--socks5-gssapi-service[24m   sockd\n"
"              would  use sockd/proxy-name --socks5 proxy-name [4m--socks5-gssapi-[0m\n"
...
"              fied  with  [4m--tlsauthtype[24m.  Requires  that [4m--tlspassword[24m also be\n"
"              set.  (Added in 7.21.4)\n"
"\n"
"       --tlsv1.0\n"
...
"\n"
"              This option overrides previous uses of [4m-v,[24m [4m--verbose[24m or [4m--trace-[0m\n"
"              [4mascii[24m.\n"
"\n"
"              If this option is used several times, the last one will be used.\n"
"\n"
...
"              curl.\n"
"\n"
"              Note that if you only want  HTTP  headers  in  the  output,  [4m-i,[0m\n"
"              [4m--include[24m might be the option you're looking for.\n"
"\n"
...
"                             to a file  with  the  [4m--remote-name[24m  or  [4m--output[0m\n"
, stdout);
 fputs(
"                             option.  It's most useful in combination with the\n"
"                             [4m--remote-header-name[24m option. (Added in 7.25.1)\n"
"\n"
...
"\n"
"              [1mredirect_url   [22mWhen  an HTTP request was made without -L to fol-\n"
"                             low redirects, this variable will show the actual\n"
"                             URL  a  redirect  [4mwould[24m  take  you  to. (Added in\n"
"                             7.18.2)\n"
"\n"
, stdout);
 fputs(
...
"              used, the default speed-limit will be 1 unless set with [4m-Y[24m.\n"
"\n"
, stdout);
 fputs(
...
, stdout);
 fputs(
"              with [4m-y[24m and is 30 if not set.\n"
"\n"
"              If this option is used several times, the last one will be used.\n"
"\n"
