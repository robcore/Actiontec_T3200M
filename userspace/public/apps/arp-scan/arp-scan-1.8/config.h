...
#define ARP_INT64 long long int

/* Define to the appropriate snprintf format for 64-bit ints. */
#define ARP_INT64_FORMAT ""
...
#define ARP_UINT64 unsigned long long int

/* Define to the appropriate snprintf format for unsigned 64-bit ints. */
#define ARP_UINT64_FORMAT ""
...
#define PACKAGE_BUGREPORT "arp-scan@nta-monitor.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "arp-scan"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "arp-scan 1.8"
