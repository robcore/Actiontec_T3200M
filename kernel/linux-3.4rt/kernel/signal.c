...
#endif
#if defined(GPL_CODE_INTERNET_LED_BEHAVIOR)
	/*just monitor smd and ssk demon */
	if (!strcmp(current->comm, "smd") || !strcmp(current->comm, "ssk"))
		aei_set_internet_red_led(0);
#endif
	printk("\n");
	preempt_disable();
	show_regs(regs);
...
#if 0
// In 3.4 kernel, mips arch doesn't have dump_user_backtrace function
#ifdef GPL_CODE
