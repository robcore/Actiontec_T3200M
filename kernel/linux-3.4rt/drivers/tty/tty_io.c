...
void (*aei_console_write_hook)(const char *msg, unsigned int len) = NULL;
EXPORT_SYMBOL(aei_console_write_hook);
						...
						size_t count, loff_t *ppos)
{
	...
	if(aei_console_write_hook != NULL)
	{
		aei_console_write_hook(buf, count);
	}
