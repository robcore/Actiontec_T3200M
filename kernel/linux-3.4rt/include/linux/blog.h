...
extern BlogAction_t blog_finit_locked(struct fkbuff *fkb_p, void * dev_p,
                             uint32_t encap, uint32_t channel, uint32_t phyHdr, void **txdev_pp);
...
typedef BlogAction_t (* BlogDevRxHook_t)(void * fkb_skb_p, void * dev_p,
                                       BlogFcArgs_t * args);

typedef BlogAction_t (* BlogDevTxHook_t)(void * fkb_skb_p, void * dev_p,
